...
--
-- Host: 127.0.0.1
-- Tempo de geração: 20/06/2023 às 19:21
...
(1, 'Programação web', '2021-02-01', 'Programação para sistemas webs'),
(2, 'Informática essencial', '2021-02-01', 'Curso de introdução a informática abordando sistema operacional, word, powerpoint e excel'),
...
(4, 'Excel avançado', '2021-02-01', 'Curso de especialização em planilhas eletrônicas'),
...
(6, 'Informática Bits', '2022-09-01', 'Curso básico para adolescentes de 12 a 14 anos');
...
CREATE TABLE `perguntas` (
  ...
  `enunciadoPergunta` text NOT NULL,
