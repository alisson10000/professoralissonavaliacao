...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Set-2023 às 21:53
...
(143, 5, 'No scratch sÃ³ Ã© possÃ­vel criar um ator.', 0, 1),
(144, 5, 'No scratch nÃ£o Ã© possÃ­vel dar movimento para os atores.', 0, 1),
(145, 5, 'Nos sensores Ã© possivel atrelar algum evento a uma tecla quando acionada.', 1, 1),
(146, 5, 'Na plataforma Scratch existe uma seÃ§Ã£o para poder trabalho com o som nos jogos.', 1, 1),
(147, 5, ' Scratch possui uma funÃ§Ã£o de detecÃ§Ã£o de colisÃµes que facilita a interatividade em jogos.', 1, 1),
(148, 5, 'Ã‰ possÃ­vel programar a interaÃ§Ã£o com teclado e mouse no Scratch.', 1, 1),
(149, 5, ' Scratch nÃ£o permite a integraÃ§Ã£o de multim?dia, como imagens e sons, nos projetos.', 0, 1),
(150, 5, 'O Scratch nÃ£o Ã© especialmente projetado para ensinar programaÃ§Ã£o a crianÃ§as e jovens.', 0, 1),
(151, 5, 'Scratch Ã© usado em contextos educacionais para ensinar conceitos de ciÃªncias da computaÃ§Ã£o.', 1, 1),
(152, 5, 'O Scratch permite a exportaÃ§Ã£o de projetos para serem executados offline.', 0, 1);
